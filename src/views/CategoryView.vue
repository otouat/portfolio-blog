        ...
        <div class="ZCLayout">
            <div class="ZCContent">
                ...
                <h1 class="page-title">
                    ...
                    <span class="page-title__count" v-if="currentName"
                        >{{ filteredPosts.length }} posts</span
                    >
                </h1>
...
// Get the corresponding name from dynamic route params; treat 'index' as empty.
...
const filteredPosts = computed(
    () => posts[props.type]?.[currentName.value] ?? [],
);
</script>
