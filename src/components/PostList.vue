<template>
    <div class="post-list">
        <a
            v-for="post in posts"
            :key="post.title"
            :href="withBase(post.permalink)"
            class="post-item"
        >
            <div class="post-item__header">
                <h2 class="post-item__title">
                    <span
                        v-if="post.order && showPinned"
                        class="post-item__pinned"
                    >
                        <Icon
                            class="post-item__pinned-icon"
                ...
                <a
                    v-if="post.category"
                    :href="withBase(categoryLink(post.category))"
